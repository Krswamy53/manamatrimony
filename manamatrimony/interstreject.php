...
<body>
    ...
    <div class="mainn">
        <div class="left">
            ...
            <a class="nav-link active" data-toggle="tab" href="#sent" id="sentInterestBtn"><h3><i class="fas fa-paper-plane"></i> All Sent Interests</h3></a>
                    ...
                    <h3 class="fh3">Interst Recived Rejected</h3>
                    </a>
                    </li>
                    </ul>
    ...
    if (isset($_SESSION['id'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "SELECT * FROM user_profiles WHERE express='reject'";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<h4 style='color: white; background-color: green; border: 1px solid green; padding: 5px; border-radius: 5px; margin-right: 10px; cursor: pointer' onclick='acceptInterest(" . $row["id"] . ")'><i class='fa-solid fa-badge-check'></i> Accept</h4>";
