                        ...
                        <div class="pricing-block col-lg-4 col-md-4 col-sm-4 wow fadeInUp">
                            ...
                            <form method="post" action="" name="my_plan">
                                ...
                                <div class="inner-box">
                                    ...
                                    <p class="contacts">
                                        <span class="price" style="font-size:15px;">Allowed Contacts/Address:100</span>
                                    ...
                                    <div class="btn-box">
                                        ...
                                        <button type="submit" class="theme-btn"><a
                                                class="theme-btn btn btn-style-one"><span class="btn-title">Pay
                                                    Now</span></a></button>
                                    </div>
                                    ...
                                    <input type="hidden" name="pm" value="op4" class="formtext"
                                        onClick="getPayForm(this.value)" checked>
                        ...
                        <div class="pricing-block col-lg-4 col-md-4 col-sm-4 wow fadeInUp">
                            ...
                            <form method="post" action="" name="my_plan">
                                ...
                                <div class="inner-box">
                                    ...
                                    <p class="contacts">
                                        <span class="price" style="font-size:15px;">Allowed Contacts/Address:999</span>
                        ...
                        <div class="pricing-block col-lg-4 col-md-4 col-sm-4 wow fadeInUp">
                            ...
                            <form method="post" action="" name="my_plan">
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="price-box">
                                        <div class="title">SUPERseUPAR</div>
                                        <h4 class="price">INR: 2100 <i class='fa fa-inr'></i> <br>
                                            Days 180 </h4>
                                    </div>
                                    <ul class="features">
                                        <li class="true">Profile Display</li>
    ...
    <div class="pricing-block col-lg-12 col-md-12 col-sm-12 wow fadeInUp">
        <div class="col-sm-12 ">
            <div class="contact-grid1 text-center">
                <p>
                <div><span style="font-size:18px"><strong>Bank Details</strong></span></div>

                <div>&nbsp;</div>

                <div><span style="font-size:16px">Bank Name: Union Bank Of India</span></div>
                ...
                <div><span style="font-size:16px"><strong><span style="color:#6699ff"></span></strong></span></div>

                <div><a
                        href="https://payu.in/invoice/8582BEDC6CC3BB6BD07AE654B08B200AB4E077BB1B5C9A3125CB81FCF45AECE4/254650D2457779EA22957CEDDCC3DA50">Online</a>
                </div>
