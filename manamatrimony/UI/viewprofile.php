    ...
    <div class="mainn">
        ...
        <div class="right">
            <div class="rightone">
                <div class="rightme">
                    <div class="col-md-12">
                        <div class="member-info" style="color:green">
                            Basic Details
                ...
                <div class="profile-details">
                    <div class="profile-column">
                        <div class="profile-field">
                            <strong>Name:</strong> <?php echo $user_profile['firstName']; ?>
                        </div>
                        <div class="profile-field">
                    ...
                    <div class="profile-column">
                        <div class="profile-field">
                            <strong>Mother Tongue:</strong> <?php echo $user_profile['mother_tongue'] ?? ''; ?>
                        </div>
                        <div class="profile-field">
                            <strong>Mobile:</strong> <?php echo $user_profile['mobile'] ?? ''; ?>
                        </div>
                        <div class="profile-field">
                            <strong>Profile Created By:</strong> <?php echo $user_profile['profile_created_by'] ?? ''; ?>
                        </div>
                        <div class="profile-field">
                            <strong>Marital Status:</strong> <?php echo $user_profile['marital_status'] ?? ''; ?>
                        </div>
                    </div>
                </div>
