			...
			<div class="auto-container">
				...
				<div class="row">
						...
						<div class="inner-box">
							...
							<div class="info-box">
								...
								<span class="designation">
									BHM (Hotel Managemen </span>
								<span class="designation">
									Finance and Accounts </span>
								<span class="designation">
									32 Yrs,
									5Ft 2 inch
								</span>
								...
								<ul class="social-links social-icon-colored">
									<div class="wrapper">
										<li><a href="login.html" target="_blank"><i
													class="fas fa-user fa-skype"></i></a></li>
										<div class="tooltip"> Profile </div>
									</div>
									<div class="wrapper">
										<li><a href="login.html" target="_blank"><i
													class="fas fa-heart fa-google-plus"></i></a></li>
										<div class="tooltip"> Shortlist</div>
									</div>
									<div class="wrapper">
										<li><a href="login.html" target="_blank"><i
													class="fas fa-comment-dots fa-bitbucket"></i></a></li>
										<div class="tooltip"> Message</div>
									</div>
									<div class="wrapper">
										<li><a href="login.html" target="_blank"><i
													class="fas fa-user-plus fa-bitcoin"></i></a></li>
						...
						<div class="inner-box">
							...
							<div class="social-box">
								<ul class="social-links social-icon-colored">
									...
									<div class="wrapper">
										<li><a href="loginform.php" target="_blank"><i
													class="fas fa-heart fa-google-plus"></i></a></li>
										<div class="tooltip"> Shortlist</div>
									</div>
									<div class="wrapper">
					...
					<div class="speaker-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
						<div class="inner-box">
							<div class="image-box">
								<a href="loginform.php" target="_blank">
									<figure class="image">
							...
							<div class="info-box">
								<h4 class="name"> <a href="loginform.php" target="_blank">
										ND42512</h4>
								<span class="designation">
									Null </span>
								<span class="designation">
				...
				<div align="center" class="col-lg-12">
					<ul class='styled-pagination' id="pagination">
						<ul class='styled-pagination'>
							<li class='setPage'>Page 7 of 22</li>
							<li><a href='religion_search3711.html?page=1&amp;religion'>1</a></li>
							<li><a href='religion_searchc4b3.html?page=2&amp;religion='>2</a></li>
							<li class='dot'>...</li>
							<li><a href='religion_search8394.html?page=5&amp;religion='>5</a></li>
							<li><a href='religion_search19c4.html?page=6&amp;religion='>6</a></li>
							<li><a class='active'>7</a></li>
							<li><a href='religion_searchaa9e.html?page=8&amp;religion='>8</a></li>
							<li><a href='religion_searchc812.html?page=9&amp;religion='>9</a></li>
							<li class='dot'>..</li>
							<li><a href='religion_searche27a.html?page=21&amp;religion='>21</a></li>
							<li><a href='religion_searchccc3.html?page=22&amp;religion='>22</a></li>
							<li><a href='religion_searchaa9e.html?page=8&amp;religion='><b>></b></a></li>
						</ul>
					</ul>
				</div>
