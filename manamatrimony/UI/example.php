...
<body>
        ...
        <div>
          ...
          <div class="slide-item" style="background-image: url(images/main-slider/1.jpg); height:900px;">
            ...
            <div class="container">
              ...
              <form action="indexotp.php" method="POST" class="from" onsubmit="return validateForm()">
                <div class="form-row">
                  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select id="eligion" name="eligion">
                    <option value="">Select Religion</option>
                    <!-- Add options for different religions -->
                ...
                <div class="form-group2">
                  ...
                  <label class="ch" for="terms">I accept&nbsp;<a href="terms-conditions.php"><strong>terms & conditions</strong></a>&nbsp;and&nbsp;<a href="privacy-policy.php"><strong>privacy policy</strong></a>.</label>
                </div>
            ...
            <script>
              function validateForm() {
                ...
                var religion = document.getElementById('eligion').value;
                ...
                const sha = /^([a-zA-ZÀ-ÖØ-öø-ÿ '-]){2,35}$/;
                if (profileCreatedBy == "") {
                  alert("Profile Created By field is required");
                  return false;
                } else if (!sha.test(profileCreatedBy)) {
                  alert("Profile Created for must have alphabets only!");
                  return false;
                }
                ...
                var namePattern = /^([a-zA-ZÀ-ÖØ-öø-ÿ '-]){2,35}$/;
                if (firstName == "") {
                  alert("First Name field is required");
                  return false;
                } else if (!namePattern.test(firstName)) {
                  alert("First name should be more than 2 characters and contain only letters!");
                  return false;
                }
                var namePattern = /^([a-zA-ZÀ-ÖØ-öø-ÿ '-]){2,35}$/;
                if (lastName == "") {
                  ...
                  alert("Last name should be more than 2 characters and contain only letters!");
                  return false;
                }
      ...
      <div class="auto-container">
        <div class="outer-box">
          <div class="time-counter">
            <div class="col-md-12">
              <div class="row">
                <form action="refine2.php" class="form-inline" method="post">
                <div class="col-lg-2 col-md-2 col-sm-2 form-group">  
                <label class="label" for="lookingfor"><span class="search">Looking For</span></label>
                  <select class="dropselect" name="gender" id="gender">
                ...
                <option value="female">female</option>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-2 form-group">       
                    ...
                    <select class="dropselect" name="minAge" id="minAge">
                ...
                <option value="30">30</option>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-2 form-group">
                    ...
                    <select class="dropselect" name="maxAge" id="maxAge">
                <option value="21">21</option>
                <option value="22">22</option>
                ...
                <option value="30">30</option>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-2 form-group"><span  class="search">Religion</span></label>
                  <select class="dropselect" name="religion" id="religion">
                ...
                <option value="jain">Jain</option>
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-2 form-group"><span  class="search">Caste</span></label>
                          <select class="dropselect" name="caste" id="caste">
                <option selected disabled value="">Select</option>
             ...
             <span class="btn-title1">Lets's Begin </span></button>
                    </div>
                </form>
              </div>
            </div>
              ...
              <form method="post" action="" class="form" id="contact-form">
                <div class="row clearfix">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9 mb-2 AcknowledgeSection">
                    ...
                    I Agree <a href="terms-conditions.html" target=_blank tabindex="3"><u>Terms of Service </u></a>
                    <span class="privacyPolicy"> And<a href="privacy-policy.html" target=_blank><u> Privacy
                          Policy*</u></a></span>
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9 mt-3 registerSection">
                    <span class=""> New Candidate Register ?<a href="signup.html" tabindex="7"> SignUp</a></span>
        ...
        <div class="content-column col-lg-6 col-md-12 col-sm-12">
          <div class="inner-column">
            <div class="sec-title">
              ...
              <div class="text"> Best matrimony service providerin india.Wefind the perfect life partner of you.
              </div>
              <div class="text"><a class="joining" href="#">Join us</a> now and find your life partner from our thousand's verified profiles
              </div>
            </div>
            ...
            <div class="btn-box"><a href="signup.html" class="theme-btn btn btn-style-three"><span class="btn-title">About us</span></a></div>
          </div>
        </div>
        <!-- Image Column -->
      ...
      <div class="row">
        ...
        <div class="content-column col-lg-5 col-md-12 col-sm-12">
          <div class="inner-column">
            ...
            <div class="text-box">Connect with your partner for FREE from safety of your home Download our Mobile App
              which are the Best way to find your Perfect Match. which is very easy, simple, fast, Convenient, and safe
              & secure.<p>
                Thousands of happy marriages happened through our Matrimony. <b>Yours could be next... </b>Download
                Now..!!</p>
 ...
 --><!-- Color Setting -->
  ...
  <script>
    ...
    function updateSubReligionOptions() {
        var religionSelect = document.getElementById('religion');
        var subReligionSelect = document.getElementById('caste');
        subReligionSelect.innerHTML = ''; 

        if (religionSelect.value === 'hindu') {
            var hinduOptions = [ 'any', 'Kapu', 'Reddy', 'Chowdary', 'Vaisyas','other'];
            hinduOptions.forEach(function(option) {
                var opt = document.createElement('option');
                opt.value = option;
                opt.textContent = option;
                subReligionSelect.appendChild(opt);
            });
        } else if (religionSelect.value === 'christian') {
            var christianOptions = ['Catholic', 'Eastern', 'Protestantism', 'Assyrians'];
            christianOptions.forEach(function(option) {
                var opt = document.createElement('option');
                opt.value = option;
                opt.textContent = option;
                subReligionSelect.appendChild(opt);
            });
        } else if (religionSelect.value === 'muslim') {
            var muslimOptions = ['Shaiks', 'Pathans', 'Qureshi', 'Mohammads'];
            muslimOptions.forEach(function(option) {
                var opt = document.createElement('option');
                opt.value = option;
                opt.textContent = option;
                subReligionSelect.appendChild(opt);
    ...
    document.getElementById('gender').addEventListener('change', function() {
        var minAgeSelect = document.getElementById('minAge');
        var maxAgeSelect = document.getElementById('maxAge');

        if (this.value === 'male') {
            minAgeSelect.value = '21';
            maxAgeSelect.value = '27';
    ...
    document.getElementById('religion').addEventListener('change', updateSubReligionOptions);

    
    updateSubReligionOptions();
...
<script>
    ...
    function scrollGrid(direction) {
        ...
        } else if (direction === 1 && scrollPosition < maxScroll) {
            scrollPosition += scrollAmount;
        }
