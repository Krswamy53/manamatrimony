...
<head>
    ...
    <meta name="keywords" content="matrimonysoftwarey" />
    <meta name="description" content="matrimonysoftwarey" />
    ...
    <div class="page-wrapper">
        ...
        <section class="page-title" style="background-image:url(images/background/5.jpg);">
            <div class="auto-container">
                <h1 class="d-none d-lg-block d-xl-block d-md-block">Privacy Policys</h1>
                        ...
                        <div class="inner-column">
                            <div class="sec-title">
                                ...
                                <div class="text">
                                    ...
                                    <p class="text">This Privacy Policy describes Our policies and procedures on the
                                        collection, use
                                    ...
                                    <p class="text">We use Your Personal data to provide and improve the Service. By
                                        using the
                                    ...
                                    <h3>Definitions</h3>
                                    <p class="text">For the purposes of this Privacy Policy:</p>
                                    <ul>
                                        <li>
                                            <p class="text"><strong>Account</strong> means a unique account created for
                                                You to access
                                                our Service or parts of our Service.</p>
                                        </li>
                                        <li>
                                            <p class="text"><strong>Affiliate</strong> means an entity that controls, is
                                                controlled
                                        ...
                                        <li>
                                            <p class="text"><strong>Company</strong> (referred to as either &quot;the
                                                ...
                                                refers to subhalekha.</p>
                                        </li>
                                        <li>
                                            <p class="text"><strong>Cookies</strong> are small files that are placed on
                                                Your
                                        ...
                                        <li>
                                            <p class="text"><strong>Country</strong> refers to: Andhra Pradesh, India
                                            </p>
                                        </li>
                                        <li>
                                            <p class="text"><strong>Device</strong> means any device that can access the
                                                Service such
                                                as a computer, a cellphone or a digital tablet.</p>
                                        </li>
                                        <li>
                                            <p class="text"><strong>Personal Data</strong> is any information that
                                                relates to an
                                        ...
                                        <li>
                                            <p class="text"><strong>Service Provider</strong> means any natural or legal
                                                person who
                                        ...
                                        <li>
                                            <p class="text"><strong>Usage Data</strong> refers to data collected
                                                automatically,
                                        ...
                                        <li>
                                            <p class="text"><strong>Website</strong> refers to subhalekha, accessible
                                                from <a href="http://localhost/subhalekha/UI/index.php"
                                                    rel="external nofollow noopener"
                                                    target="_blank">http://localhost/subhalekha/UI/index.php</a></p>
                                        </li>
                                        <li>
                                    ...
                                    <h4>Personal Data</h4>
                                    <p class="text">While using Our Service, We may ask You to provide Us with certain
                                        personally
                                    ...
                                    <h4>Usage Data</h4>
                                    <p class="text">Usage Data is collected automatically when using the Service.</p>
                                    <p class="text">Usage Data may include information such as Your Device's Internet
                                        Protocol
                                        address (e.g. IP address), browser type, browser version, the pages of our
                                        Service that You visit, the time and date of Your visit, the time spent on those
                                        pages, unique device identifiers and other diagnostic data.</p>
                                    <p class="text">When You access the Service by or through a mobile device, We may
                                        collect certain
                                    ...
                                    <p class="text">We may also collect information that Your browser sends whenever You
                                        visit our
                                        Service or when You access the Service by or through a mobile device.</p>
                                    <h4>Tracking Technologies and Cookies</h4>
                                    <p class="text">We use Cookies and similar tracking technologies to track the
                                        activity on Our
                                        Service and store certain information. Tracking technologies used are beacons,
                                        tags, and scripts to collect and track information and to improve and analyze
                                        Our Service. The technologies We use may include:</p>
                                    <ul>
                                        <li class="text"><strong>Cookies or Browser Cookies.</strong> A cookie is a
                                            small file placed
                                            ...
                                            may use Cookies.</li>
                                        <li class="text"><strong>Web Beacons.</strong> Certain sections of our Service
                                            and our emails
                                    ...
                                    <p class="text">Cookies can be &quot;Persistent&quot; or &quot;Session&quot;
                                        Cookies. Persistent
                                        ...
                                        learn more about cookies on TermsFeed website</a> article.</p>
                                    <p class="text">We use both Session and Persistent Cookies for the purposes set out
                                        below:</p>
                                    <ul>
                                        <li>
                                            ...
                                            <p class="text">Purpose: These Cookies are essential to provide You with
                                                services
                                        ...
                                        <li>
                                            <p class="text"><strong>Cookies Policy / Notice Acceptance Cookies</strong>
                                            </p>
                                            <p>Type: Persistent Cookies</p>
                                            <p>Administered by: Us</p>
                                            <p class="text">Purpose: These Cookies identify if users have accepted the
                                                use of cookies
                                                on the Website.</p>
                                        </li>
                                        <li>
                                            ...
                                            <p>Type: Persistent Cookies</p>
                                            <p>Administered by: Us</p>
                                            <p class="text">Purpose: These Cookies allow us to remember choices You make
                                                when You use
                                    ...
                                    <p class="text">For more information about the cookies we use and your choices
                                        regarding cookies,
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p class="text"><strong>To manage Your Account:</strong> to manage Your
                                                registration as a
                                        ...
                                        <li>
                                            <p class="text"><strong>For the performance of a contract:</strong> the
                                                development,
                                        ...
                                        <li>
                                            <p class="text"><strong>To contact You:</strong> To contact You by email,
                                                telephone
                                        ...
                                        <li>
                                            <p class="text"><strong>To provide You</strong> with news, special offers
                                                and general
                                        ...
                                        <li>
                                            <p class="text"><strong>To manage Your requests:</strong> To attend and
                                                manage Your
                                                requests to Us.</p>
                                        </li>
                                        <li>
                                            <p class="text"><strong>For business transfers:</strong> We may use Your
                                                information to
                                        ...
                                        <li>
                                            <p class="text"><strong>For other purposes</strong>: We may use Your
                                                information for
                                    ...
                                    <p class="text">We may share Your personal information in the following situations:
                                    </p>
                                    <ul>
                                        <li class="text"><strong>With Service Providers:</strong> We may share Your
                                            personal
                                            information with Service Providers to monitor and analyze the use of our
                                            Service, to contact You.</li>
                                        <li class="text"><strong>For business transfers:</strong> We may share or
                                            transfer Your
                                        ...
                                        <li class="text"><strong>With Affiliates:</strong> We may share Your information
                                            with Our
                                        ...
                                        <li class="text"><strong>With business partners:</strong> We may share Your
                                            information with
                                            Our business partners to offer You certain products, services or promotions.
                                        </li>
                                        <li class="text"><strong>With other users:</strong> when You share personal
                                            information or
                                        ...
                                        <li class="text"><strong>With Your consent</strong>: We may disclose Your
                                            personal
                                            information for any other purpose with Your consent.</li>
                                    </ul>
                                    <h3>Retention of Your Personal Data</h3>
                                    <p class="text">The Company will retain Your Personal Data only for as long as is
                                        necessary for
                                    ...
                                    <p class="text">The Company will also retain Usage Data for internal analysis
                                        purposes. Usage
                                    ...
                                    <p class="text">Your information, including Personal Data, is processed at the
                                        Company's
                                    ...
                                    <p class="text">Your consent to this Privacy Policy followed by Your submission of
                                        such
                                        information represents Your agreement to that transfer.</p>
                                    <p class="text">The Company will take all steps reasonably necessary to ensure that
                                        Your data is
                                    ...
                                    <p class="text">You have the right to delete or request that We assist in deleting
                                        the Personal
                                        Data that We have collected about You.</p>
                                    <p class="text">Our Service may give You the ability to delete certain information
                                        about You from
                                        within the Service.</p>
                                    <p class="text">You may update, amend, or delete Your information at any time by
                                        signing in to
                                        ...
                                        provided to Us.</p>
                                    <p class="text">Please note, however, that We may need to retain certain information
                                        when we have
                                        a legal obligation or lawful basis to do so.</p>
                                    <h3>Disclosure of Your Personal Data</h3>
                                    <h4>Business Transactions</h4>
                                    <p class="text">If the Company is involved in a merger, acquisition or asset sale,
                                        Your Personal
                                    ...
                                    <p class="text">Under certain circumstances, the Company may be required to disclose
                                        Your
                                        Personal Data if required to do so by law or in response to valid requests by
                                        public authorities (e.g. a court or a government agency).</p>
                                    <h4>Other legal requirements</h4>
                                    <p class="text">The Company may disclose Your Personal Data in the good faith belief
                                        that such
                                        action is necessary to:</p>
                                    
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> Comply with a legal obligation</p>
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> Protect and defend the rights or property of the Company</p>
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> Prevent or investigate possible wrongdoing in connection with the Service
                                    </p>
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> Protect the personal safety of Users of the Service or the public</p>
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> Protect against legal liability</p>
                                    
                                    <h3>Security of Your Personal Data</h3>
                                    <p class="text">The security of Your Personal Data is important to Us, but remember
                                        that no
                                        method of transmission over the Internet, or method of electronic storage is
                                        100% secure. While We strive to use commercially acceptable means to protect
                                        Your Personal Data, We cannot guarantee its absolute security.</p>
                                    <h2>Children's Privacy</h2>
                                    <p class="text">Our Service does not address anyone under the age of 13. We do not
                                        knowingly
                                    ...
                                    <p class="text">If We need to rely on consent as a legal basis for processing Your
                                        information
                                        and Your country requires consent from a parent, We may require Your parent's
                                        consent before We collect and use that information.</p>
                                    <h2>Links to Other Websites</h2>
                                    <p class="text">Our Service may contain links to other websites that are not
                                        operated by Us. If
                                        You click on a third party link, You will be directed to that third party's
                                        site. We strongly advise You to review the Privacy Policy of every site You
                                        visit.</p>
                                    <p class="text">We have no control over and assume no responsibility for the
                                        content, privacy
                                        policies or practices of any third party sites or services.</p>
                                    <h2>Changes to this Privacy Policy</h2>
                                    <p class="text">We may update Our Privacy Policy from time to time. We will notify
                                        You of any
                                        changes by posting the new Privacy Policy on this page.</p>
                                    <p class="text">We will let You know via email and/or a prominent notice on Our
                                        Service, prior to
                                        the change becoming effective and update the &quot;Last updated&quot; date at
                                        the top of this Privacy Policy.</p>
                                    <p class="text">You are advised to review this Privacy Policy periodically for any
                                        changes.
                                    ...
                                    <ul>
                                        <li>By email: mailto:subhalekha@gmail.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
