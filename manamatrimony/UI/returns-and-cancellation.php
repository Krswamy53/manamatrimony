                            ...
                            <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                ...
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="smart_search.php">Search</a>
                                        ...
                                        <ul>
                                            <li><a href="about-us.php">Quick Search</a></li>
                                            <li><a href="terms-conditions.php">Basic Search</a></li>
                                            <li><a href="faqs.php">Advanced search</a> </li>
                                            <li><a href="privacy-policy.php">Keyword Search</a></li>
                                            <li><a href="returns-and-cancellation.php">Location Search</a></li>
                                            <li><a href="disclaimer.php">Occupation Search</a></li>
                        ...
                        <div class="inner-column">
                            <div class="sec-title">
                                ...
                                <div class="text">
                                    ...
                                    <p class="text">Thank you for shopping at subhalekha.</p>
                                    ...
                                    <p class="text">You are entitled to cancel Your Order within 7 days without giving
                                        any reason for doing so.</p>
                                    <p class="text">The deadline for cancelling an Order is 7 days from the date on
                                        which You received the Goods or on which a third party you have appointed, who
                                        is not the carrier, takes possession of the product delivered.</p>
                                    <p class="text">In order to exercise Your right of cancellation, You must inform Us
                                        of your decision by means of a clear statement. You can inform us of your
                                        decision by:</p>
                                    <ul>
                                        <li>
                                            <p>By email: http://localhost/subhalekha/UI/index.php</p>
                                        </li>
                                        <li>
                                            <p>By visiting this page on our website: <a
                                                    href="http://localhost/subhalekha/UI/index.php"
                                                    rel="external nofollow noopener"
                                                    target="_blank">http://localhost/subhalekha/UI/index.php</a></p>
                                        </li>
                                    </ul>
                                    <p class="text">We will reimburse You no later than 14 days from the day on which We
                                        receive the returned Goods. We will use the same means of payment as You used
                                        for the Order, and You will not incur any fees for such reimbursement.</p>
                                    <h2>Conditions for Returns</h2>
                                    <p class="text">In order for the Goods to be eligible for a return, please make sure
                                        that:</p>
                                    
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> The Goods were purchased in the last 7 days</p>
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> The Goods are in the original packaging</p>
                                    
                                    <p class="text">The following Goods cannot be returned:</p>
                                    
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> The supply of Goods made to Your specifications or clearly personalized.
        </p>
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> The supply of Goods which according to their nature are not suitable to be
                                            returned, deteriorate rapidly or where the date of expiry is over.</p>
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> The supply of Goods which are not suitable for return due to health
                                            protection or hygiene reasons and were unsealed after delivery.</p>
                                        <p><i class="fa fa-check-circle" aria-hidden="true"></i> The supply of Goods which are, after delivery, according to their nature,
                                            inseparably mixed with other items.</p>
                                    
                                    <p class="text">We reserve the right to refuse returns of any merchandise that does
                                        not meet the above return conditions in our sole discretion.</p>
                                    <p class="text">Only regular priced Goods may be refunded. Unfortunately, Goods on
                                        sale cannot be refunded. This exclusion may not apply to You if it is not
                                        permitted by applicable law.</p>
                                    <h2>Returning Goods</h2>
                                    <p class="text">You are responsible for the cost and risk of returning the Goods to
                                        Us. You should send the Goods at the following address:</p>
                                    <!-- <p>home</p> -->
                                    <p class="text">We cannot be held responsible for Goods damaged or lost in return
                                    ...
                                    <h2>Gifts</h2>
                                    <p class="text">If the Goods were marked as a gift when purchased and then shipped
                                        directly to you, You'll receive a gift credit for the value of your return. Once
                                        the returned product is received, a gift certificate will be mailed to You.</p>
                                    <p class="text">If the Goods weren't marked as a gift when purchased, or the gift
                                        giver had the Order shipped to themselves to give it to You later, We will send
                                        the refund to the gift giver.</p>
                                    <h3>Contact Us</h3>
