...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- loginform -->
        <form id="registrationForm" name="reg" method="post" action="forgotpasswordopt.php">
            <div class="login-container">
                <h2 style="color:#EB2869;">Recover my password</h2>
                ...
                <!-- <div class="check">
                    ...
                    <div class="forgot-password">
                        <p class=""><a href="3">Forgot your password?</a></p>
                    </div>
                </div> -->

                <button class="login-btn" name="submit" type="submit">Send otp</button><br><br>
                <!-- <p align=center>OR</p>
