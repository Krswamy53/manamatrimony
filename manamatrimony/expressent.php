...
?>
        ...
        <div class="mainn">
            ...
            <a class="nav-link active" data-toggle="tab" href="#sent" id="sentInterestBtn"><h3><i class="fas fa-paper-plane"></i> All Sent Interests</h3></a>
                        ...
                        <h3 class="fh3">Find Your Life Partner Preferences</h3>
                        </a>
                        </li>
                        </ul>
...
if (isset($_SESSION['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "SELECT * FROM user_profiles WHERE gender = '$opposite_gender' AND caste = '$user_caste'";
        $result = $conn->query($sql);
        ...
        echo "<p style='font-size: 16px; font-weight: bold;'><strong>Subcaste:</strong> <span style='color:green;'> " . $row["subcaste"] . "</p>";
                ...
                echo "<h4 style='color: green; cursor: pointer;' class='message' onclick='openPopup(" . $row['id'] . ")'><i class='fas fa-envelope'></i> Send Message</h4>";

               
                echo "<div style='display: flex; gap: 50px;'>";
                
                

                echo "<h5 style='color: white; background-color: salmon; border: 1px solid salmon; padding: 5px; border-radius: 5px; cursor: pointer;' onclick='deleteItem(" . $row["id"] . ")'><i class='fa fa-trash'></i> Delete</h5>";
                echo "</div>";
...
?>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    // Event listener for reminder icon click
                    $('.reminder-icon').on('click', function() {
                        var receiverId = $(this).data('recipient_id');
