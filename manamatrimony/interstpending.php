...
<body>
    ...
    <div class="mainn">
        <div class="left">
            ...
            <a class="nav-link active" data-toggle="tab" href="#sent" id="sentInterestBtn"><h3><i class="fas fa-paper-plane"></i> All Sent Interests</h3></a>
                    ...
                    <h3 class="fh3">Interst Recived Pending</h3>
                    </a>
                    </li>
                    </ul>
    ...
    if (isset($_SESSION['id'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "SELECT * FROM user_profiles WHERE express='pending'";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<h6 style='color: white; background-color: green; border: 1px solid green; padding: 5px; border-radius: 5px; margin-right: 10px; cursor: pointer'> Send Message</h5>";
                    echo "<div style='display: flex; gap: 10px;'>";

                    echo "<h6 style='color: white; background-color: green; border: 1px solid green; padding: 5px; border-radius: 5px; margin-right: 10px; cursor: pointer' onclick='acceptInterest(" . $row["id"] . ")'> Accept</h5>";
                    echo "<h6 style='color: white; background-color: green; border: 1px solid green; padding: 5px; border-radius: 5px; margin-right: 10px; cursor: pointer' onclick='rejectInterest(" . $row["id"] . ")'> Reject</h5>";
                   
                    
                    echo "<h6 style='color: white; background-color: salmon; border: 1px solid green; padding: 5px; border-radius: 5px; cursor: pointer;' onclick='deleteItem(" . $row["id"] . ")'> Delete</h5>";
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
                }
