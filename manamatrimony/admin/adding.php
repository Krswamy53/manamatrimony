        ...
        <option value="2" >Kaal Sarp Dosh                                                            </option>
                ...
                <div id="upload-photos" class="tab-pane fade">
                    <div class="container mt-3">
                        ...
                        <button class="btn btn-primary next-tab one" data-toggle="tab" href="#partner-preference">Next</button>
    ...
    <div class="form-group col-md-6">
        ...
        <select class="form-control" id="par_annualIncome" name="par_annualIncome" required>
            ...
            <!-- Add more options as needed -->
                    ...
                    <input  class="custom-button" type="submit" name="educationOccupationSubmit" value="Submit">
                </div>
