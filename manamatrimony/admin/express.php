        ...
        <div class="custom-scroll">
            ...
            <ul>
                        <h5 style="color:red;">Welcome, <?php echo $name; ?></h5>
                            ...
                            <li class="sidebar-item"><a href="express.php" class="sidebar-link active" data-bs-toggle="tooltip" data-bs-placement="right"  tabindex="0"><i class="bi bi-hexagon-fill"></i> <span>Expreess Interest </span></a></li>
