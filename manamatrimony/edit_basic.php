            ...
            <div class="edit-profile">
                ...
                <form action="" method="POST">
                    ...
                    <input type="text" name="maritalStatus"
                        value="<?php echo $user_profile['maritalStatus']; ?>"><br><br>
                    <label>Smoking Habits:</label>
                    <input type="text" name="smokingHabits"
                        value="<?php echo $user_profile['smokingHabits']; ?>"><br><br>
                    <label>Drinking Habits:</label>
                    <input type="text" name="drinkingHabits"
                        value="<?php echo $user_profile['drinkingHabits']; ?>"><br><br>
                    <label>Physical Status:</label>
                    <input type="text" name="physicalStatus"
                        value="<?php echo $user_profile['physicalStatus']; ?>"><br><br>
                    <label>Diet:</label>
