    ...
    <div class="mainn">
        ...
        <div class="right">
            ...
            detailfrom Here </p> -->
                <div class="spot">
                    <form method="POST">
                        <label for="visibility">Profile Picture Setting</label>
                        <select name="visibility" id="visibility">
                            <option value="visible">Visible</option>
                            <option value="invisible">Invisible</option>
                        </select>
                        <button type="submit" name="updateVisibility" style="background-color: orangered; color: white; padding: 5px 10px; border: none; border-radius: 4px; cursor: pointer; font-size: 12px;">
                            Update
                        </button>
