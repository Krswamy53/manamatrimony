...
<div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
    ...
    // Get the corresponding anchor element based on the current page URL
    var currentAnchor = document.getElementById(currentPage);

    // Add the "current" class to the parent <li> element if it exists
    if (currentAnchor) {
    ...
    <!-- <script>
        function validateForm() {
            ...
            if (password == "" || password == null) {
                ...
                alert(
                    "Password must be at least 8 characters long and contain at least one uppercase letter,special character");
                return false;
            }
