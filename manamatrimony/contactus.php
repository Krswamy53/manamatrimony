                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                ...
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="current dropdown active"><a href="contactus.php">Contact</a></li>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (isLoggedIn) {
                    ...
                    mobileUserBox.innerHTML = '<span class="theme-btn btn-style-one btn-title">Welcome, ' + username + '!</span>' +
                        '<a href="logout" class="theme-btn btn-style-one ml-4 mt-2"><span class="btn-title">Logout</span></a>';
                } else {
                            ...
                            <form method="post" action="" id="contact-form">
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        <input type="text" maxlength="40" name="name" placeholder="Name"
                                            onKeyPress="return ValidateAlpha(event); return blockSpecialChar(event);"
                                            tabindex="1" required>
                                    </div>

                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        <input type="text" maxlength="10" name="phone" placeholder="Phone" tabindex="2"
                                            onBlur="check_exist1(this.value);"
                                            onkeypress="return isValidPhoneNumber(event)" required>
                                    </div>


                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        <input type="email" name="email" maxlength="35" placeholder="Email"
                                            onkeyup="nospaces(this)" tabindex="3" required="">
                                    </div>

                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        <input type="text" name="subject" maxlength="70" placeholder="Subject"
                                            tabindex="4"
                                            onKeyPress="return ValidateAlpha(event); return blockSpecialChar(event);"
                                            required>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        ...
                                        <textarea name="message" maxlength="250" placeholder="Message"
                                            onKeyPress="return ValidateAlpha(event); return blockSpecialChar(event);"
                                            tabindex="5"></textarea>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                                        ...
                                        <button class="theme-btn btn btn-style-one" type="submit" name="submit"
                                            style="width:100%"><span class="btn-title" tabindex="11">Submit
                                                Now</span></button>
