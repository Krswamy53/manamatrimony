            ...
            <div class="userpro">
                <form action="" method="POST">
                    ...
                    <div class="seconduser">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 form-group">
                            <select class="custom-select-box ages selcs" title="country" id="country" name="country"
                                required tabindex="3" size="1">
                    ...
                    <div class="thirduser">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 form-group">
                            <select class="custom-select-box ages selcs" name="city" id="city" required tabindex="3"
                                size="1">
