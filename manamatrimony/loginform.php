...
if (isset($_POST['submit'])) {
    ...
    $password = $_POST['password']; // No need to escape since it's not used in SQL directly

    // Query to check if user exists based on email or mobile
    $sql = "SELECT * FROM user_profiles WHERE email = '$emailOrMobile' OR mobile = '$emailOrMobile'";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            $_SESSION['id'] = $row['id'];
            $_SESSION['firstName'] = $row['firstName']; // Store the name in session
            ...
            echo ("<script>
                alert('Invalid email or mobile number or password');
    ...
    <div class="page-wrapper">
        ...
        <header class="main-header header-style-two">
                ...
                <div class="auto-container clearfix">
                    ...
                    <div class="nav-outer clearfix">
                        ...
                        <div class="outer-box">
                            ...
                            <!-- Button Box -->
                            <div class="btn-box">
                                <a href="loginfrom.php" class="theme-btn btn btn-style-one"><span
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    ...
                    <a href="loginfrom.php" class="theme-btn btn-style-one ml-4 mt-2"><span
                            class="btn-title">Login</span></a>
        ...
        <form id="registrationForm" name="reg" method="post" onsubmit="return validateForm()" action="">
            <div class="login-container">
                <h2 style="color:#EB2869;">LOGIN</h2>
                <p><span class="text">Click</span><a href="index.php" class="animated-text">Register here</a> </p>
                <div></div>
                ...
                <div class="check">
                    ...
                    <div class="forgot-password">
                        <p class=""><a href="forgotpassword.php">Forgot your password?</a></p>
                    </div>
                </div>

                <button class="login-btn" name="submit" type="submit">Login Now</button><br><br>
                <p align=center>OR</p>
                <button class="otp-btn">Login With Gmail</button><br><br>
